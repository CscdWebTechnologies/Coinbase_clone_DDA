...
const Section4 = () => {
  return (
    <Container className="containerSec7">
      <JumboHeader
        header="Create your cryptocurrency portfolio today"
              ...
              >
                <svg width="36" height="38" viewBox="0 0 36 38">
                  <g fill="none" fill-rule="evenodd">
                    ...
                    ></path>
                    <path
                      d="M27.313 4.75v2.375a2.375 2.375 0 004.75 0V4.75h-4.75zM5.938 9.5a2.375 2.375
                         0 002.375-2.375V4.75h-4.75v2.375A2.375 2.375 0 005.937 9.5"
                      fill="#1752F0"
                    ></path>
                    <path
            ...
            <Row className="sec4Row">
              ...
              >
                <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
                  ...
                  <path
                    d="M28.125 36H7.875a1.128 1.128 0 01-1.125-1.125V1.125C6.75.506 7.256 0 7.875 0h20.25c.618
                     0 1.125.506 1.125 1.125v33.75c0 .619-.507 1.125-1.125 1.125z"
                    fill="#56B4FC"
                  ></path>
                  <path
